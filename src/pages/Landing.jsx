...
import { ArrowRight, Globe, Shield, Zap, Users, Loader2 } from 'lucide-react';
        ...
        <div className="min-h-screen bg-slate-50 dark:bg-slate-900 text-slate-900 dark:text-white overflow-hidden relative selection:bg-indigo-500 selection:text-white">
            ...
            <nav className="flex items-center justify-between px-6 py-6 max-w-7xl mx-auto">
                ...
                <div className="flex items-center gap-4">
                    {user ? (
                        <Link to="/feed" className="px-6 py-2.5 rounded-xl font-bold bg-indigo-600 hover:bg-indigo-700 text-white shadow-lg shadow-indigo-500/30 transition hover:scale-105 flex items-center gap-2">
