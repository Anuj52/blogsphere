  ...
  return (
    <GlassCard className="bg-white/60 dark:bg-slate-900/60 border-slate-200 dark:border-indigo-500/20 backdrop-blur-xl">
      ...
      <div className="space-y-2">
        {trendingPosts.length === 0 && <p className="text-slate-400 dark:text-white/20 text-sm italic">No trending posts yet.</p>}
          ...
          >
            <div className="flex items-center gap-3 min-w-0 overflow-hidden">
              ...
              <div className="truncate">
                <p className="text-sm font-medium text-slate-700 dark:text-indigo-100 group-hover:text-slate-900 dark:group-hover:text-white truncate">
                  {post.title}
                </p>
                <p className="text-xs text-slate-400 dark:text-white/40 group-hover:text-slate-600 dark:group-hover:text-white/60 truncate">
